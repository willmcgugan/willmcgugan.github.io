...
Most developers seem to be either all-in or passionately opposed to AI (with a definite leaning towards the all-in camp).
...
Why is this *good* AI?
It means that skills acquired in the age before AI [^1] are still applicable and even valuable.
We have a little time before mindless automatons force senior developers into new careers as museum exhibits with the other fossils, tapping on their mechanical keyboards in front of gawping school kids.
...
If you maintain any popular Open Source project you may be familiar with AI generated Pull Requests, easily identifiable by their long bullet lists in the description.
Many (but not all) are from developers who copied an issue from a project into their prompt, prefixed with the words "please fix".
...
This is bad AI, because it typically takes more time for the maintainer to review such PRs than the creator took to type in the prompt.
...
Good code is good code, whether generated by a fleshy mammalian brain or a mechanical process.
And it is undeniable that AI code can be *good* code.

## The Experiment

This makes me wonder if the job of maintainer could be replaced entirely with AI.
...
An AI agent will review those issues, responds to comments, and may tag them with "todo" or close the issue if they don't reach a bar for relevance and quality.
